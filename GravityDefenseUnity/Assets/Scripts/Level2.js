...
// ninth round
round = LevelDescriptor.CreateRound();
round.name = "The Final Countdown";
round.moneyEarned = 0;
wave = LevelDescriptor.CreateWave();
...
direction.angle = convertAngle(-45 - 90);
direction.asteroidType = "basic";
direction.asteroidNb = 8;
direction.asteroidLife = 1;
direction.moneyEarned = 0;
wave.AddDirection(direction);

direction = LevelDescriptor.CreateDirection();
direction.angle = convertAngle(-45 - 90 + 10);
direction.asteroidType = "basic";
direction.asteroidNb = 8;
direction.asteroidLife = 1;
direction.moneyEarned = 0;
...
direction = LevelDescriptor.CreateDirection();
direction.angle = convertAngle(-45 - 90 + 180);
direction.asteroidType = "basic";
direction.asteroidNb = 8;
direction.asteroidLife = 1;
direction.moneyEarned = 0;
...
direction = LevelDescriptor.CreateDirection();
direction.angle = convertAngle(-45 - 90 + 10 + 180);
direction.asteroidType = "basic";
direction.asteroidNb = 8;
direction.asteroidLife = 1;
direction.moneyEarned = 0;
...
direction = LevelDescriptor.CreateDirection();
direction.angle = convertAngle(180 - 20);
direction.asteroidType = "ship";
direction.asteroidNb = 8;
direction.asteroidLife = 1;
direction.moneyEarned = 0;
...
direction = LevelDescriptor.CreateDirection();
direction.angle = convertAngle(180);
direction.asteroidType = "splittable";
direction.asteroidNb = 1;
direction.asteroidLife = 8;
direction.asteroidScale = 8;
